    ...
    TUD_AUDIO_DESC_IAD(                                                                                                           \
        ...
        TUD_AUDIO_DESC_CS_AC(                                                                                                     \
            ...
            /*_totallen*/ TUD_AUDIO_DESC_CLK_SRC_LEN                                                                              \
                ...
                + TUD_AUDIO_DESC_INPUT_TERM_LEN                                                                                   \
                + TUD_AUDIO_DESC_OUTPUT_TERM_LEN, /*_ctrl*/                                                                       \
        ...
        TUD_AUDIO_DESC_OUTPUT_TERM(                                                                                               \
            ...
            /*_clkid*/ UAC2_ENTITY_CLOCK,                                                                                         \
            /*_ctrl*/ 0x0000, /*_stridx*/                                                                                         \
            0x00),                                                                                                                \
        /* Standard AS Interface Descriptor(4.9.1) */ /* Interface 1, Alternate 0 - default alternate setting with 0 bandwidth */ \
        TUD_AUDIO_DESC_STD_AS_INT(                                                                                                \
            /*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK),                                                                   \
            /*_altset*/ 0x00,                                                                                                     \
            /*_nEPs*/ 0x00, /*_stridx*/                                                                                           \
            0x05),                                                                                                                \
        /* Standard AS Interface Descriptor(4.9.1) */ /* Interface 1, Alternate 1 - alternate interface for data streaming */     \
        TUD_AUDIO_DESC_STD_AS_INT(                                                                                                \
            /*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK),                                                                   \
            /*_altset*/ 0x01,                                                                                                     \
            /*_nEPs*/ 0x01, /*_stridx*/                                                                                           \
        ...
        TUD_AUDIO_DESC_STD_AS_INT(                                                                                                \
            ...
            /*_nEPs*/ 0x00, /*_stridx*/                                                                                           \
            0x04),                                                                                                                \
        /* Standard AS Interface Descriptor(4.9.1) */ /* Interface 2, Alternate 1 - alternate interface for data streaming */     \
        TUD_AUDIO_DESC_STD_AS_INT(                                                                                                \
            /*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_MIC),                                                                   \
            /*_altset*/ 0x01,                                                                                                     \
            /*_nEPs*/ 0x01, /*_stridx*/                                                                                           \
